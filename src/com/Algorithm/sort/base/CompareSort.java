...
//            a[i] = num;
        ...
        String func = "com/Algorithm/sort";
        String claz1 = "com.Algorithm.sort.select.Selection";
        System.out.println("Selection spended time is "+  CalcTime.calcLastTime(claz1,func,a));
//        String claz2 = "com.Algorithm.sort.insert.Insertion";
//        System.out.println("Insertion spended time is "+  CalcTime.calcLastTime(claz2,func,b));

//        String claz3 = "com.Algorithm.sort.hillSort.Shell";
